...
select * from users
insert into users values('longahihi','long',1,'longahihi.jpg');
insert into users values('hoaahihi','hoa',1,'hoaahihi.jpg');
insert into users values('hungahihi','hung',1,'hungahihi.jpg');
insert into users values('huyahihi','huy',1,'huyahihi.jpg');
----Tu thhem
