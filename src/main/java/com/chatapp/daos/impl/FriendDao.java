...
public class FriendDao extends GenericDao<Friend> {
	...
	public void unFriend(String sender, String receiver) {
		StringBuilder sql1 = new StringBuilder();
		StringBuilder sql2 = new StringBuilder();
		sql1.append("delete friends where sender = ? and receiver = ?");
		sql2.append("delete friends where sender = ? and receiver = ?");
		save(sql1.toString(), sender, receiver);
		save(sql2.toString(), receiver, sender);
	}
